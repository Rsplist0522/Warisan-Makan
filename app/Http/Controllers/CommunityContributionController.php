...
class CommunityContributionController extends Controller
{
    ...
    private function validateContribution(Request $request, ?HeritageShopContribution $contribution = null): array
    {
        $validated = $request->validate([
            ...
            'city' => ['required_if:submission_action,submit', 'nullable', 'string', 'max:100'],
            'state' => ['required_if:submission_action,submit', 'nullable', 'string', 'max:100'],
            'postal_code' => ['required_if:submission_action,submit', 'nullable', 'string', 'max:20', 'regex:/^[0-9]+$/'],
