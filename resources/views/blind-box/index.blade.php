            ...
            result.innerHTML = `
                ...
                <div style="display: flex; gap: 30px; align-items: start; flex-wrap: wrap; justify-content: center;">
                    <div style="position: relative; width: 300px; height: 300px; flex-shrink: 0;">
                        ...
                        <span class="year-badge" style="font-size: 0.9rem; padding: 8px 15px; position: absolute; bottom: 15px; right: 15px; background: var(--red-dark); color: white; border-radius: 50px;">${BLIND_BOX_TEXT.estimated} ${shop.year || BLIND_BOX_TEXT.heritage}</span>
                    </div>
