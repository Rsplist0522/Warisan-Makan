...
return [
    ...
    'max_image_kb' => (int) env('HERITAGE_SHOP_MAX_IMAGE_KB', 2048),
    'max_image_bytes' => (int) env('HERITAGE_SHOP_MAX_IMAGE_KB', 2048) * 1024,
    'max_gallery_images' => (int) env('HERITAGE_SHOP_MAX_GALLERY_IMAGES', 10),
