...
class BlindBoxAdminTest extends TestCase
{
    ...
    public function test_removed_shop_returns_to_the_pending_list(): void
    {
        ...
        $response->assertSeeInOrder(['Shops Pending Selection', 'Kedai Kopi Pak Hassan']);
        $response->assertDontSeeInOrder(['Shops Included in the Blind Box', 'Kedai Kopi Pak Hassan']);
    ...
    public function test_removed_shop_is_not_available_to_the_draw_pool(): void
    {
        ...
        $response->assertDontSee('Kedai Kopi Pak Hassan');
    }
}
